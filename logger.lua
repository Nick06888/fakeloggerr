...
TextLabel_3.Text = "Gui & Code Remade: Calabrese#0001"
...
TextLabel_4.Text = "Gui & Code Revamp: Calabrese#0001"
...
local SayMessageRequest2 = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest
SayMessageRequest2:FireServer(
"Completato data inviata a [%Encryped Site%]",
"All"
)
end)
